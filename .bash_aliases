...
alias lt='ls -laht modified -sold --color=auto'
alias ltr='ls -laht modified -snew --color=auto'
alias ln='ln -si'
alias mv='mv -iv'
alias cp='cp -ripv'
alias rm='rm -rv'
...
alias cl='column'
alias du='du -h'
alias diff='delta --syntax-theme Nord'
alias md='mkdir -p'
alias rd='rmdir'
alias ps='ps auxf'
alias kl='kill'
...
alias unlock='gkeyring -k login --unlock'
